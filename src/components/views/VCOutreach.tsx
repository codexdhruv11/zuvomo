...
export function VCOutreach() {
  ...
  const filteredLeads = useMemo(() => {
    ...
    if (selectedPeriod === "last-7-days") {
      ...
      return vcLeads.filter(lead => new Date(lead.lastContact) >= sevenDaysAgo);
    }
    return vcLeads;
  }, [selectedPeriod]);
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">VC Outreach</h1>
          <p className="text-muted-foreground">Manage your VC lead pipeline</p>
        </div>
        <div className="flex gap-2">
          ...
          <AddLeadForm editLead={editingLead} onClose={() => setEditingLead(null)}>
            <Button size="sm">Add VC Lead</Button>
          </AddLeadForm>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900">
          <CardHeader>
            <CardTitle className="text-purple-700 dark:text-purple-300">Total VC Leads</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>VC Leads Database</CardTitle>
          <CardDescription>Manage your VC outreach pipeline</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <Badge className="bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-300">VC</Badge>
