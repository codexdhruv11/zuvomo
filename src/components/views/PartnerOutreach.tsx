...
const partnerLeads = [
  {
    ...
    email: "alex@strategicpartners.com",
  ...
  },
  {
    id: 10,
    name: "Maria Garcia",
    company: "Global Alliance Corp",
    email: "maria@globalalliance.com",
    ...
    notes: "Ready to discuss joint venture terms"
  }
];

export function PartnerOutreach() {
  ...
  const filteredLeads = useMemo(() => {
    ...
    if (selectedPeriod === "last-7-days") {
      ...
      return partnerLeads.filter(lead => new Date(lead.lastContact) >= sevenDaysAgo);
    }
    return partnerLeads;
  }, [selectedPeriod]);
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Partner Outreach</h1>
          <p className="text-muted-foreground">Manage your partnership lead pipeline</p>
        </div>
        <div className="flex gap-2">
          ...
          <AddLeadForm editLead={editingLead} onClose={() => setEditingLead(null)}>
            <Button size="sm">Add Partner Lead</Button>
          </AddLeadForm>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-950 dark:to-green-900">
          <CardHeader>
            <CardTitle className="text-green-700 dark:text-green-300">Total Partner Leads</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Partner Leads Database</CardTitle>
          <CardDescription>Manage your partnership outreach pipeline</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <Badge className="bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300">Partner</Badge>
